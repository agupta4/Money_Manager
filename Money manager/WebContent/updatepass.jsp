		...
		<div class="container-page">				
			<div class="col-md-6">
				...
				<div class="form-group col-lg-12">
					...
					<input type="password" name="pass1" class="form-control" id="" value="" autocomplete = "off" required = "required">
				</div>
				<div class="form-group col-lg-12">
					<label>Confirm Password</label>
					<input type="password" name="pass2" class="form-control" id="" value="" autocomplete = "off" required = "required">
				</div>
