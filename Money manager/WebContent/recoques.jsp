    ...
    <section class="container">
		<div class="container-page">				
			<div class="col-md-6">
				...
				<form action = "RecoController" method = "POST">
				<div class="form-group col-lg-12">
				<%while(rs.next()){ %>
					<label>Question:<%out.println(rs.getString(1));}%></label>
				</div>
				<div class="form-group col-lg-12">
					<label>Answer:</label>
					<input type="text" name="answer" class="form-control" id="" value="" autocomplete = "off">
				</div>
			<div class = "form-group col-lg-12">
