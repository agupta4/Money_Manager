...
<div class="container">
	...
	<form method="post" action="changeQues" class="form-horizontal"
		role="form">
		...
		<div class="form-group">
        				<label class="control-label col-sm-2" for="title">Enter Your New Question</label><br>
        				<div class="col-sm-5">
			...
			<div class="col-sm-offset-2 col-sm-5">
				<button type="submit" value="Submit" class="btn btn-default">Submit</button>
			     ...
			     <div class="col-sm-offset-2 col-sm-5">
		      		<a class="btn btn-default" href="changeAns.jsp" role="button">Change your Answer</a>
		      		</div>
